...
class StudentIotScreen extends ConsumerStatefulWidget {
  const StudentIotScreen({super.key});

  @override
  ConsumerState<StudentIotScreen> createState() => _StudentIotScreenState();
}

class _StudentIotScreenState extends ConsumerState<StudentIotScreen> {
