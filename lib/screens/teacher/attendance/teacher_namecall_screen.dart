...
final currentTimetableSlotProvider = FutureProvider.family<
  TimetableModel?,
  String
>((ref, classId) async {
...
class _TeacherNamecallScreenState extends ConsumerState<TeacherNamecallScreen> {
  ...
  Future<void> _saveStudentAttendance(
    ...
    try {
      ...
      final data = {
        ...
        'sessionName': slot != null ? '${slot.subject} Session' : '',
        'roomId': slot?.roomId ?? '',
  ...
  Widget _buildStatsBar(List<StudentModel> students, bool isDark) {
    final present =
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Spacer(),
            Text('${students.length} students', style: AppTypography.caption),
          ],
        ),
      ),
    );
