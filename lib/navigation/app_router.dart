  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (_, __) => const AdminStaffListScreen(),
      ),
      GoRoute(
        path: AppRoutes.adminTeacherPresence,
        builder: (context, state) => const AdminTeacherPresenceScreen(),
      ),
      GoRoute(
      ...
      GoRoute(
        path: AppRoutes.adminSemesters,
        name: 'admin-semesters',
        builder: (context, state) => const AdminSemesterScreen(),
      ),
      GoRoute(
